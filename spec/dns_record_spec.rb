...
describe DDNSSD::DNSRecord do
  ...
  shared_examples 'an A record with absolute values' do
    describe '#name' do
  ...
  shared_examples 'a AAAA record with absolute values' do
    describe '#name' do
      it 'is the absolute name' do
        expect(record.name).to eq('foo.example.com')
      end
  ...
  shared_examples 'a SRV record with absolute values' do
    describe '#name' do
      it 'is the absolute name' do
  ...
  shared_examples 'a PTR record with absolute values' do
    describe '#name' do
      it 'is the absolute name' do
  ...
  shared_examples 'a TXT record with absolute values' do
    describe '#name' do
      it 'is the absolute name' do
        expect(record.name).to eq('_bar._foo._tcp.example.com')
      end
  ...
  shared_examples 'a CNAME record with absolute values' do
    describe '#name' do
      it 'is the absolute name' do
  ...
  describe '#new_absolute_from_relative' do
    let(:base_domain) { "example.com" }

    context "with an A record" do
      let(:record) { DDNSSD::DNSRecord.new_absolute_from_relative(
        base_domain, DDNSSD::DNSRecord.new("foo", 42, :A, "192.0.2.42"))
      }
      it_behaves_like 'an A record with absolute values'
    end
    ...
    context "with a AAAA record" do
      let(:record) { DDNSSD::DNSRecord.new_absolute_from_relative(
        base_domain, DDNSSD::DNSRecord.new("foo", 42, :AAAA, "2001:db8::42")
      ) }
      it_behaves_like 'a AAAA record with absolute values'
    end
    ...
    context "with a SRV record" do
      let(:record) { DDNSSD::DNSRecord.new_absolute_from_relative(
        base_domain, DDNSSD::DNSRecord.new("_bar._foo._tcp", 42, :SRV, 2, 4, 8, "bar")
      ) }
      it_behaves_like 'a SRV record with absolute values'
    end
    ...
    context "with a PTR record" do
      let(:record) { DDNSSD::DNSRecord.new_absolute_from_relative(
        base_domain, DDNSSD::DNSRecord.new("_foo._tcp", 42, :PTR, "_bar._foo._tcp")
      ) }
      it_behaves_like 'a PTR record with absolute values'
    end
    ...
    context "with a TXT record" do
      let(:record) { DDNSSD::DNSRecord.new_absolute_from_relative(
        base_domain, DDNSSD::DNSRecord.new("_bar._foo._tcp", 42, :TXT, 'something "funny"', "this too")
      ) }
      it_behaves_like 'a TXT record with absolute values'
    end
    ...
    context "with a CNAME record" do
      let(:record) { DDNSSD::DNSRecord.new_absolute_from_relative(
        base_domain, DDNSSD::DNSRecord.new("something", 42, :CNAME, "guy-incognito")
      ) }
      it_behaves_like 'a CNAME record with absolute values'
    end
    ...
    context "with a mystery record" do
      let(:record) { DDNSSD::DNSRecord.new_absolute_from_relative(
        base_domain, DDNSSD::DNSRecord.new("example.com", 60, :NS, "ns1.example.com")
      ) }
